...
- [Reporting a bug](#reporting-a-bug)
    ...
    - [Reporting a ctx creation bug](#reporting-a-ctx-creation-bug)
...
Please verify that ctx creation also fails with the `glfwinfo` tool before
...
GLFW ctx and framebuffer hints.  Run `glfwinfo -h` for a complete list.
